...
public class AutoCompleteInput : MonoBehaviour
{
    ...
    void OnInputChanged(string input)
    {
        ...
        this.tabSystem.switchToTab("推薦字");
    ...
    void Update()
    {
        ...
        if (this.tabSystem.currentTabName != "推薦字")  // If the current tab is not the suggesstion panel, the player cannot select any suggesstion
            return;
