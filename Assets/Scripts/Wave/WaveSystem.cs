...
public class WaveSystem : MonoBehaviour
{
    ...
    private const string exampleMessage_sentence_o_string = "One more sentence that is very different from the previous ones with bracket.";
    ...
    private async Task<List<string>> RequestSentenceGPT(string vocabulary, int num_of_sentence)
    {
        ...
        ChatMessage sentence_o = new ChatMessage(ChatMessageRole.User, "One more sentence that is very different from the previous ones with bracket.");
